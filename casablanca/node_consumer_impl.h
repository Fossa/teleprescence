...
public:
	...
	virtual void auth_user(std::string cookie, std::string room, std::function<void(int, std::string)> cb);
	// virtual void layout_change(int room_id, int layout[], size_t sz);
	virtual void layout_change( std::string room_id, std::vector< int > layout);
